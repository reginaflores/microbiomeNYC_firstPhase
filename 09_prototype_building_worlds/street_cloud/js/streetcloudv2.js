//StreetCloud attributed to:
//https://github.com/callumprentice/callumprentice.github.io/tree/master/apps/street_cloud
...
var default_lat = 40.7362553;
var default_lng = -73.9925026;
...
function init() {
    ...
    // var sphere = new THREE.Mesh( new THREE.SphereGeometry( 500, 60, 60 ), new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'img/pano.jpg' ) } ) );
    // sphere.scale.x = -1;
    ...
    material = new THREE.ShaderMaterial( {
        ...
        uniforms: { 
            tShine: { type: "t", value: THREE.ImageUtils.loadTexture( 'img/pano.jpg' ) },
            time: { type: "f", value: 0 },
    ...
    //alert(document.getElementById( 'vertexShader' ).textContent);
    
    //here is teh big sphere
    mesh = new THREE.Mesh( new THREE.IcosahedronGeometry( 3, 5 ), material );
    scene.add( mesh );
    ...
    gui.add(this, "point_size", 0.1, 0.5).name("Point size").onChange(function (value) {
